...
pro new_sn1987a_image_analysis_auto,lobes=lobes,ring=ring,ptsrc=ptsrc,bilat=bilat, lobsrc=lobsrc ,all=all
  ...
  FOR f=0,N_ELEMENTS(files)-1 DO BEGIN
     ...
     CASE STRLEN(obsids[f]) OF
        ...
        5: obs = obsids[f]
     ENDCASE
     files[f] = obs+'_300-8000_smoothed.img'
  ENDFOR
...
;        PRINT, 'im = ',im
        ...
        new_sn1987a_fit,newim,a,sigma,chisq,dof,iter,fitim,perror,lobes=lobes,ring=ring,ptsrc=ptsrc,bilat=bilat,lobsrc=lobsrc
        rdis,im
        rdis,newim
        rdis,fitim
