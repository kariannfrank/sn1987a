def broken_line(x,intercept,slope1,changepoint1,slope2,changepoint2,slope3):
    """
    Return Y(x), where the function is broken line with parameters pars.
    ...
    pars : numerical list
      list of parameters for the broken line function:
      [intercept,slope1,changepoint1,slope2,changepoint2,slope3]
